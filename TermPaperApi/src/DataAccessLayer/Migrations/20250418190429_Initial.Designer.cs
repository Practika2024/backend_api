...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20250418190429_Initial")]
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.Products.ProductImageEntity", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_product_image_entity");

                    b.HasIndex("ProductId")
                        .HasDatabaseName("ix_product_image_entity_product_id");

                    b.ToTable("product_image_entity", (string)null);
                });
            ...
            modelBuilder.Entity("DataAccessLayer.Entities.Products.ProductImageEntity", b =>
                {
                    b.HasOne("DataAccessLayer.Entities.Products.ProductEntity", "Product")
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_product_image_entity_products_product_id");
